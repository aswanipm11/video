...
if(caption=="" || cover_image=="" || video_url=="")
{
  ...
  return (
    <div className='p-3'>
      {/* <i onClick={handleShow} class="fa-solid fa-file-arrow-up fa-flip fa-3x " style={{ color: "black" }}></i> */}

      <i  onClick={handleShow}  class="fa-solid fa-angles-down fa-beat-fade fa-3x text-white"></i>
